    ...
    try:
        with conn.cursor() as cursor:
            for item in departments.keys():
                ...
                print(sql, fechaObj.strftime( '%Y-%m-%d' ), contdata['confirmados'], contdata['decesos'], contdata['recuperados'], contdata['sospechosos'], contdata['descartados'], res['departamento'][item]['total'])
            ...
            for dep in departments.keys():
                ...
                for item in data:
                    if item['departament'] == dep:
                        ...
                        data_json_death[ dep ].append( int(item['deaths']) )
